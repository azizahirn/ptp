...
$connection = new mysqli($servername, $username, $password, $database);
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $sql = "SELECT * FROM clients WHERE participant_id = $participant_id";
    ...
    do{
      if( empty($participant_id) || empty($fullname) || empty($profile) || empty($email) || empty($phonenumber) || empty($site) || empty($reason) || empty($poetryverses) || empty($ytlink)) {
      $errorMessage = "All fields are required";
      break;
    }

    $sql = "UPDATE clients SET fullname = '$fullname', profile = '$profile', email = '$email', phonenumber = '$phonenumber', site = '$site', reason = '$reason', poetryverses = '$poetryverses', ytlink = '$ytlink'" .
